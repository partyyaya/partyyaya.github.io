import{m as v}from"./markdown-it-75be01fa.js";import{H as b}from"./highlight.js-867ee1b1.js";import{_ as f,L as N,t as n,s as i,u as y}from"../js/index-3fb62596.js";import{m as _}from"./mdCopy-c8cfacf4.js";import{a as e,o as A,j,e as s,f as u,k as w,l as p,m as l,q as S,F as $}from"./@vue-6bb656f0.js";import"./clipboard-3a281e2a.js";import"./entities-96bc23f9.js";import"./uc.micro-174787a3.js";import"./mdurl-4b1f5cdc.js";import"./linkify-it-59decb82.js";import"./vue-router-ec6d6ff4.js";/* empty css                      */import"./lodash-7e818ff8.js";const V=`## Vuex \u7B46\u8A18
...
- \u7BC4\u4F8B\uFF1A
  ...
  - \`\`\`App.vue\`\`\` \u8B8A\u66F4\u4EE3\u78BC\uFF1A
    ...
    \`\`\`
`;let o=e(!0),c=e(!1),d=e(!0),h=e(!1);const x=e(""),C={name:"VuexNote",components:{Loading:N},setup(){return A(async()=>{if(o.value){const a=v({html:!0,linkify:!0,typographer:!0,highlight(r,m){return b.highlight(r,{language:m}).value}}).use(_);x.value=a.render(`${V}`),await n(()=>{o.value=!1},1e3).then(()=>n(()=>{d.value=!1,h.value=!0},500)).then(()=>n(()=>{c.value=!0,i()},100))}else i()}),y(),{showLoading:o,showContent:c,displayLoading:d,displayContent:h,htmlContent:x}}},L=["innerHTML"];function M(a,r,m,t,T,k){const g=j("Loading");return s(),u($,null,[t.displayLoading?(s(),w(g,{key:0,class:p({"content--hide":!t.showLoading,"content--show":t.showLoading})},null,8,["class"])):l("",!0),t.displayContent?(s(),u("div",{key:1,class:p({"markdown-content":!0,"content--hide":!t.showContent,"content--show":t.showContent})},[S("div",{class:"markdown-body",innerHTML:t.htmlContent},null,8,L)],2)):l("",!0)],64)}const K=f(C,[["render",M]]);export{K as default};
