import{m as g}from"./markdown-it-75be01fa.js";import{H as b}from"./highlight.js-867ee1b1.js";import{_ as x,L as f,t,s as d,u as k}from"../js/index-3fb62596.js";import{m as y}from"./mdCopy-c8cfacf4.js";import{a as e,o as W,j as C,e as i,f as c,k as _,l as p,m,q as z,F as E}from"./@vue-6bb656f0.js";import"./clipboard-3a281e2a.js";import"./entities-96bc23f9.js";import"./uc.micro-174787a3.js";import"./mdurl-4b1f5cdc.js";import"./linkify-it-59decb82.js";import"./vue-router-ec6d6ff4.js";/* empty css                      */import"./lodash-7e818ff8.js";const P=`## \u79FB\u52D5\u7AEF\u9069\u914D \u7B46\u8A18
...
- \u89E3\u6C7A\u65B9\u6CD5\uFF1A
  ...
  - \`css\` \u5C6C\u6027\u8A2D\u7F6E\uFF1A 
    ...
    \`\`\`
`;let o=e(!0),l=e(!1),h=e(!0),w=e(!1);const v=e(""),A={name:"MobileAdaptationNote",components:{Loading:f},setup(){return W(async()=>{if(o.value){const a=g({html:!0,linkify:!0,typographer:!0,highlight(r,s){return b.highlight(r,{language:s}).value}}).use(y);v.value=a.render(`${P}`),await t(()=>{o.value=!1},1e3).then(()=>t(()=>{h.value=!1,w.value=!0},500)).then(()=>t(()=>{l.value=!0,d()},100))}else d()}),k(),{showLoading:o,showContent:l,displayLoading:h,displayContent:w,htmlContent:v}}},q=["innerHTML"];function j(a,r,s,n,L,S){const u=C("Loading");return i(),c(E,null,[n.displayLoading?(i(),_(u,{key:0,class:p({"content--hide":!n.showLoading,"content--show":n.showLoading})},null,8,["class"])):m("",!0),n.displayContent?(i(),c("div",{key:1,class:p({"markdown-content":!0,"content--hide":!n.showContent,"content--show":n.showContent})},[z("div",{class:"markdown-body",innerHTML:n.htmlContent},null,8,q)],2)):m("",!0)],64)}const K=x(A,[["render",j]]);export{K as default};
