import{m as f}from"./markdown-it-75be01fa.js";import{H as k}from"./highlight.js-867ee1b1.js";import{_ as w,L as j,t,s as l,u as v}from"../js/index-3fb62596.js";import{m as x}from"./mdCopy-c8cfacf4.js";import{a as e,o as y,j as _,e as s,f as c,k as C,l as p,m as u,q as S,F as P}from"./@vue-6bb656f0.js";import"./clipboard-3a281e2a.js";import"./entities-96bc23f9.js";import"./uc.micro-174787a3.js";import"./mdurl-4b1f5cdc.js";import"./linkify-it-59decb82.js";import"./vue-router-ec6d6ff4.js";/* empty css                      */import"./lodash-7e818ff8.js";const E=`## Webpack \u7B46\u8A18
...
`;let o=e(!0),d=e(!1),m=e(!0),h=e(!1);const g=e(""),L={name:"WebpackNote",components:{Loading:j},setup(){return y(async()=>{if(o.value){const a=f({html:!0,linkify:!0,typographer:!0,highlight(r,i){return k.highlight(r,{language:i}).value}}).use(x);g.value=a.render(`${E}`),await t(()=>{o.value=!1},1e3).then(()=>t(()=>{m.value=!1,h.value=!0},500)).then(()=>t(()=>{d.value=!0,l()},100))}else l()}),v(),{showLoading:o,showContent:d,displayLoading:m,displayContent:h,htmlContent:g}}},q=["innerHTML"];function W(a,r,i,n,z,M){const b=_("Loading");return s(),c(P,null,[n.displayLoading?(s(),C(b,{key:0,class:p({"content--hide":!n.showLoading,"content--show":n.showLoading})},null,8,["class"])):u("",!0),n.displayContent?(s(),c("div",{key:1,class:p({"markdown-content":!0,"content--hide":!n.showContent,"content--show":n.showContent})},[S("div",{class:"markdown-body",innerHTML:n.htmlContent},null,8,q)],2)):u("",!0)],64)}const Q=w(L,[["render",W]]);export{Q as default};
