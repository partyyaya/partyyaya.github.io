import{m as b}from"./markdown-it-75be01fa.js";import{H as f}from"./highlight.js-867ee1b1.js";import{_ as w,L as v,t,s as l,u as T}from"../js/index-9e5a4999.js";import{m as x}from"./mdCopy-c8cfacf4.js";import{a as e,o as k,j as L,e as r,f as c,k as D,l as u,m as p,q as S,F as C}from"./@vue-6bb656f0.js";import"./clipboard-3a281e2a.js";import"./entities-96bc23f9.js";import"./uc.micro-174787a3.js";import"./mdurl-4b1f5cdc.js";import"./linkify-it-59decb82.js";import"./vue-router-ec6d6ff4.js";/* empty css                      */import"./lodash-7e818ff8.js";const _=`## Typescript \u7B46\u8A18
...
- Utility Types \u5BE6\u7528\u7A0B\u5E8F\u985E\u578B
  ...
  - \u7BC4\u4F8B\uFF1A
    ...
    \`\`\`
`;let s=e(!0),m=e(!1),h=e(!0),g=e(!1);const d=e(""),N={name:"TSNote",components:{Loading:v},setup(){return k(async()=>{if(s.value){const o=b({html:!0,linkify:!0,typographer:!0,highlight(i,a){return f.highlight(i,{language:a}).value}}).use(x);d.value=o.render(`${_}`),await t(()=>{s.value=!1},1e3).then(()=>t(()=>{h.value=!1,g.value=!0},500)).then(()=>t(()=>{m.value=!0,l()},100))}else l()}),T(),{showLoading:s,showContent:m,displayLoading:h,displayContent:g,htmlContent:d}}},P=["innerHTML"];function I(o,i,a,n,U,E){const y=L("Loading");return r(),c(C,null,[n.displayLoading?(r(),D(y,{key:0,class:u({"content--hide":!n.showLoading,"content--show":n.showLoading})},null,8,["class"])):p("",!0),n.displayContent?(r(),c("div",{key:1,class:u({"markdown-content":!0,"content--hide":!n.showContent,"content--show":n.showContent})},[S("div",{class:"markdown-body",innerHTML:n.htmlContent},null,8,P)],2)):p("",!0)],64)}const K=w(N,[["render",I]]);export{K as default};
