import{m as v}from"./markdown-it-37da2622.js";import{H as y}from"./highlight.js-867ee1b1.js";import{_ as w,L as U,t,s as u,u as L}from"../js/index-3fe1e07a.js";import{m as x}from"./mdCopy-ec244029.js";import{r as e,o as b,q as k,k as r,l as p,t as S,v as h,x as l,y as H,F as j}from"./@vue-50cf967a.js";import"./clipboard-12221ac4.js";import"./entities-96bc23f9.js";import"./uc.micro-174787a3.js";import"./mdurl-4b1f5cdc.js";import"./linkify-it-59decb82.js";import"./punycode-f726180d.js";import"./vue-i18n-2d92e57f.js";import"./@intlify-f70c4c62.js";import"./vue-router-339d5de3.js";/* empty css                      */import"./lodash-acc62a92.js";const R=`## Vue Router \u7B46\u8A18
...
- \u4F7F\u7528\u7BC4\u4F8B\uFF1A
  ...
  */
  ...
  \`\`\`
`;let o=e(!0),m=e(!1),c=e(!0),d=e(!1);const g=e(""),_={name:"VueRouterNote",components:{Loading:U},setup(){return b(async()=>{if(o.value){const s=v({html:!0,linkify:!0,typographer:!0,highlight(a,i){return y.highlight(a,{language:i}).value}}).use(x);g.value=s.render(`${R}`),await t(()=>{o.value=!1},1e3).then(()=>t(()=>{c.value=!1,d.value=!0},500)).then(()=>t(()=>{m.value=!0,u()},100))}else u()}),L(),{showLoading:o,showContent:m,displayLoading:c,displayContent:d,htmlContent:g}}},C=["innerHTML"];function E(s,a,i,n,F,P){const f=k("Loading");return r(),p(j,null,[n.displayLoading?(r(),S(f,{key:0,class:h({"content--hide":!n.showLoading,"content--show":n.showLoading})},null,8,["class"])):l("",!0),n.displayContent?(r(),p("div",{key:1,class:h({"markdown-content":!0,"content--hide":!n.showContent,"content--show":n.showContent})},[H("div",{class:"markdown-body",innerHTML:n.htmlContent},null,8,C)],2)):l("",!0)],64)}const K=w(_,[["render",E]]);export{K as default};
